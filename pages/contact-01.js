                                    ...
                                    <div className="row">
                                        <div className="col-md-6">
                                            <div className="contact-box">
                                                <Link href="/tel:1-917-582-3220" title="Call us" className="background-navy">Call us<span>1-917-582-3220</span></Link>
                                            </div>
                                        </div>
                                        <div className="col-md-6">
                                            <div className="contact-box">
                                                <Link href="/mailto:dan@decksketch.ai" title="Email us" className="background-dark">Email us<span>dan@decksketch.ai</span></Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
